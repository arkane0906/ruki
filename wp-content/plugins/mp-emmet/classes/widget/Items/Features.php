...
class MP_Emmet_Plugin_Widget_Features extends MP_Emmet_Plugin_Widget_Default {
	...
	function widget( $args, $instance ) {
		...
		<div class="features-box">
			...
			<?php elseif ( ! empty( $icon ) ): ?>
				<div class="features-icon features-fa-icon ">
	...
	function form( $instance ) {
		...
		<p><label
				for="<?php echo $this->get_field_id( 'icon' ); ?>"><?php _e( 'Alternative <a href="http://fontawesome.io/icons/" target="_blank">Font Awesome 4.3</a> icon name like "fa-wordpress"', 'mp-emmet' ); ?></label>
