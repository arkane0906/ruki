...
b.when(motopressCE.tinyMCEInited[CE.Iframe.wpEditorId]).done(function(a){CE.Iframe.wpEditor=a}));"html-active"===f&&(g?switchEditors.switchto(b("#"+CE.Iframe.mpceEditorId+"-tmce")[0]):switchEditors.go(CE.Iframe.mpceEditorId,"tmce"));b.when(motopressCE.tinyMCEInited[CE.Iframe.mpceEditorId]).done(function(a){CE.Iframe.mpceEditor=a;c.renderContent(d,c.getEditableContent(CE.Iframe.mpceEditor),e)})}else c.renderContent(d,c.getEditableContent(null),e)},getEditableContent:function(a){return a?a.getContent({format:"html"}):
CE.Iframe.mpceTextarea.val().length?switchEditors._wp_Autop(CE.Iframe.mpceTextarea.val()).replace(RegExp("\n","g"),""):""},appendScript:function(a,c){a.appendChild(c)},prependScript:function(a,c){a.insertBefore(c,a.firstChild)},wpLinkCloseCallback:function(a){b("#wp-link").on("wpdialogclose.motopress",function(c){b("#wp-link").off("wpdialogclose.motopress");a()})},preventUnload:function(){this.body.find("a").on("click",function(a){a.preventDefault()});this.body.find("form").on("submit",function(a){a.preventDefault()});
var a=!1;b(window).on("beforeunload.CE.Iframe",function(){a=!0});b(CE.Iframe.window).on("beforeunload.CE.Iframe",function(){if(!a)return localStorage.getItem("postSaveAlert");a=!1})},resizeWindow:function(){CE.Iframe.window.CE.Utils.triggerWindowEvent("resize")},setMinWidth:function(){this.element.css("min-width",this.minWidth)},unsetMinWidth:function(){this.element.css("min-width","")}})}(jQuery),function(b){can.Control("CE.Navbar",{myThis:null},{iframe:b("#motopress-content-editor-scene"),editorEl:b("#motopress-content-editor"),
...
".motopress-content-editor-preview-edit click":function(a,c){this.unsetPreview();this.hide();CE.Navbar.myThis.show()},preview:function(a){null===this.mode&&(CE.Iframe.window.CE.Selectable.myThis.unselect(),CE.Iframe.window.CE.StyleEditor.myThis.unsetEmulateCSSMode(),CE.Iframe.window.CE.InlineEditor.destroyAll(),CE.Iframe.window.CE.Utils.addSceneAction("device-preview"),CE.Iframe.myThis.unsetMinWidth());if(a!==this.mode){var c=null!==this.mode?this.previewClassPrefix+this.mode:"",b=this.previewClassPrefix+
...
CE.Iframe.myThis.body.removeClass(a);CE.Iframe.myThis.setMinWidth();CE.Iframe.window.CE.Utils.removeSceneAction("device-preview");this.mode=null}})}(jQuery),function(b){var a=MP.WpRevision;CE.Save=can.Construct({contentSavedInCE:!1,compareString:"",mpceEditor:null,init:function(){this.mpceEditor=tinyMCE.get("motopresscecontent")},saveWithReload:function(){this.triggerBeforeSave();this.makeContentNonDirty();b("form#post #save-post").click()},publishWithReload:function(){this.triggerBeforeSave();this.makeContentNonDirty();
b("form#post #publish").click()},saveAJAX:function(){this.triggerBeforeSave();var a=b("form#post").serializeArray(),d=this;return b.ajax({type:"post",data:a,success:function(a){MP.Editor.triggerEverywhere("AfterUpdate");d.contentSavedInCE=!0},error:function(a){console.log(a)}}).done(this.makeContentNonDirty)},triggerBeforeSave:function(){MP.Editor.triggerEverywhere("BeforeSave")},makeContentNonDirty:function(){a.setBuilderDirty(!1);a.makeWpNonDirty()},convertAndInsert:function(){var a=CE.Iframe.contents.find("body .motopress-content-wrapper");
a.length&&(a=this.getSources("",a),null!==parent.CE.Iframe.mpceEditor&&parent.CE.Iframe.mpceEditor.setContent(a,{format:"html"}),parent.CE.Iframe.mpceTextarea.val(parent.switchEditors._wp_Nop(a)))},getSources:function(a,d,e){"undefined"===typeof e&&(e=1);var f=this,g=null,k=null,g=1===e?parent.CE.Iframe.myThis.gridObj.row.shortcode:parent.CE.Iframe.myThis.gridObj.row.inner;d.children(".motopress-row, .mpce-wp-more-tag").each(function(){var d=b(this);if(1===e&&d.hasClass("mpce-wp-more-tag"))a+="\x3c!--more--\x3e";
else{var l=parent.MP.Utils.getEdgeRow(b(this));a+="<p>["+g+f.getAttributes(d)+"]</p>";l.children(".motopress-clmn").each(function(){var d=b(this),g=MP.Utils.getEdgeSpan(d),h=MP.Utils.getSpanClass(d.prop("class").split(" ")),h=MP.Utils.getSpanNumber(h),l="",m="",m=d.get(0).style.minHeight;if(m.length){var n=parseInt(m);isNaN(n)||n===CE.Iframe.window.CE.Resizer.myThis.minHeight||n===CE.Iframe.window.CE.Resizer.myThis.spaceMinHeight||(l=' style="min-height: '+m+';"')}parent.CE.Iframe.myThis.gridObj.span.type&&
"multiple"===parent.CE.Iframe.myThis.gridObj.span.type?(k=1===e?parent.CE.Iframe.myThis.gridObj.span.shortcode[h-1]:parent.CE.Iframe.myThis.gridObj.span.inner[h-1],m=""):(m=" "+parent.CE.Iframe.myThis.gridObj.span.attr+'="'+h+'"',k=1===e?parent.CE.Iframe.myThis.gridObj.span.shortcode:parent.CE.Iframe.myThis.gridObj.span.inner);a+="<p>["+k+m+l+f.getAttributes(d)+"]</p>";a=g.children(".motopress-row").length?f.getSources(a,g,e+1):f.getShortcode(a,g.find(".motopress-block-content > [data-motopress-shortcode]"));
a+="<p>[/"+k+"]</p>"});a+="<p>[/"+g+"]</p>"}});return a},getShortcode:function(a,b){if(b.length){var e="",f=b.attr("data-motopress-shortcode"),g=b.attr("data-motopress-close-type"),k="undefined"!==typeof b.attr("data-motopress-unwrap"),h="",l="";"enclosed"===g&&(g=(g=b.attr("data-motopress-content"))?g.replace(/\[\]/g,"["):"",e+=g,l="<p>[/"+f+"]</p>");k&&this.isEmptyStyles(b)||(h="<p>["+f+this.getAttributes(b)+"]</p>",e=h+e+l);a+=e}return a},changeContent:function(){a.setBuilderDirty(!0)},getAttributes:function(a){var d=
{},e=a.attr("data-motopress-parameters")?JSON.parse(a.attr("data-motopress-parameters")):{},f=a.attr("data-motopress-styles")?JSON.parse(a.attr("data-motopress-styles")):{};b.extend(d,e,f);var g="";if(d){var e=a.attr("data-motopress-group"),k=a.attr("data-motopress-shortcode"),h=CE.Iframe.window.CE.LeftBar.myThis.library[e].objects[k].parameters;if(k===parent.CE.Iframe.myThis.gridObj.span.shortcode||k===parent.CE.Iframe.myThis.gridObj.span.inner)a.hasClass("motopress-empty")&&(d.hasOwnProperty(parent.CE.Iframe.myThis.gridObj.span.custom_class_attr)||
...
(d[parent.CE.Iframe.myThis.gridObj.span.custom_class_attr].value=""),d[parent.CE.Iframe.myThis.gridObj.span.custom_class_attr].value+=" motopress-space");b.each(d,function(a,c){h.hasOwnProperty(a)&&h[a].hasOwnProperty("saveInContent")&&"true"==h[a].saveInContent&&(c.value="");if(-1!==b.inArray(k,["mp_row","mp_row_inner"])){if(h.hasOwnProperty(a)&&"undefined"!==typeof h[a].disabled&&"true"===h[a].disabled&&-1!==b.inArray(a,"bg_video_youtube bg_video_youtube_cover bg_video_webm bg_video_mp4 bg_video_ogg bg_video_cover parallax_image parallax_bg_size".split(" ")))return;
"full_height"===a&&h.hasOwnProperty(a)&&h[a]["default"]===c.value&&(c.value="");if(h.hasOwnProperty(a)&&h[a].dependency&&d[h[a].dependency.parameter].value!==h[a].dependency.value&&("undefined"===typeof h[a].disabled||"false"===h[a].disabled))return}"undefined"!==typeof c.value&&""!==c.value&&(g+=" "+a+'="'+c.value+'"')})}return g},isEmptyStyles:function(a){var d=!0;a=a.attr("data-motopress-styles")?JSON.parse(a.attr("data-motopress-styles")):{};b.each(a,function(a,b){"undefined"!==typeof b.value&&
