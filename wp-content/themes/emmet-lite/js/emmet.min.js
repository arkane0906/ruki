...
a(".masonry-blog"),c=0;a(".site-header").length&&(c=a(".site-header").offset().top);a(window).load(function(){h();g();k();a.isFunction(a.fn.masonry)&&a.isFunction(a.fn.infinitescroll)&&(b.masonry({itemSelector:".post",columnWidth:function(a){return a/3},animationOptions:{duration:400},isRTL:a("body").is(".rtl")}),b.infinitescroll({navSelector:".navigation",nextSelector:".navigation a:last-child",itemSelector:".masonry-blog .post",loading:{finishedMsg:"",img:template_directory_uri.url+"/images/loader.svg",
msgText:""}},function(d){var e=a(d).addClass("masonry-hidden");a(e).imagesLoaded(function(){b.masonry("appended",a(e),!0);g();k();setTimeout(function(){a(e).removeClass("masonry-hidden")},500)})}));a(".animated").appear();a(document.body).on("appear",".animated",function(b,e){a(this).hasClass("animation-active")||m(a(this))});a(".animated:appeared").each(function(){a(this).addClass("animation-active");m(a(this))})});a(window).scroll(function(){var b=a(window).scrollTop();"on"===a(".site-header").attr("data-sticky-menu")&&
(a(this).scrollTop()>c?a(".site-header").addClass("fixed"):a(".site-header").removeClass("fixed"));var e=0;"on"===a(".site-header").attr("data-sticky-menu")&&767<a(window).width()&&(e=a(".site-header").hasClass("fixed")?a(".site-header").outerHeight():a(".site-header").outerHeight()+a(".site-header").outerHeight());var g=a(".site-header").outerHeight(),f="no";a("section").each(function(){var c="#"+jQuery(this).attr("id"),h=jQuery(this).offset().top,l=jQuery(this).outerHeight(),k=a("#wpadminbar").height(),
l=h+l-g-e;if(b>=h-g-k&&b<=l)return f="yes",a("#main-menu .current").removeClass("current"),a('#main-menu a[href$="'+c+'"]').parent("li").addClass("current"),!1;"no"==f&&a("#main-menu .current").removeClass("current")})});a(window).resize(function(){h();g()})})})(jQuery);
